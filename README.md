...
- **Multiple code blocks per note** — Each code block can reference a different property or file.
...
Add an `xmind-pal` code block in any note. The plugin supports several syntaxes:
